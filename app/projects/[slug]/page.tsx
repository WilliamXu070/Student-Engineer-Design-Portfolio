...
const praxisIFigures: Record<string, PraxisIFigure> = {
  ...
  slider: {
    refKey: "02",
    src: "/context-evidence/raw/praxis1-annotated.png",
...
const praxisICtmfLessons: Record<string, string> = {
  ...
  "functional-prototyping":
    "Let the team evaluate how each mechanism actually performed during opening, especially in noise reduction, control, and mess.",
  "morphological-chart":
...
const civ102Figures: Record<string, PraxisIFigure> = {
  ...
  crossSection: {
    refKey: "02",
    src: "/context-evidence/raw/civ102-final-bridge-cross-section.png",
  ...
  loadingConfiguration: {
    refKey: "03",
    src: "/context-evidence/raw/civ102-loading-configuration.png",
  ...
  timeLog: {
    refKey: "11",
    src: "/context-evidence/raw/civ102-time-log.png",
...
const praxisIIFigures: Record<string, PraxisIFigure> = {
  ...
  onePagerFront: {
    refKey: "05",
    src: "/context-evidence/raw/praxis2-one-pager-front.png",
  ...
  onePagerBack: {
    refKey: "05b",
    src: "/context-evidence/raw/praxis2-one-pager-back.png",
